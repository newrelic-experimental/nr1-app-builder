...
if [ "" == "$2" ]; then
  echo A nerdlet name is required.
  exit 1
fi
...
cp ./loader/index.js $1/nerdlets/$2
cp ./loader/styles.scss $1/nerdlets/$2
mkdir -p $1/nerdlets/drawer
cp ./loader/drawer* $1/nerdlets/drawer
